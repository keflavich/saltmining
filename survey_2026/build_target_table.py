...
SPECIAL_DIST_REF = {
    ...
    "G076.3829-00.6210":   r"\citet{Xu2013}",
    "G083.0936+03.2724":   r"\citet{Panja2024}",
    "G232.6207+00.9959":   r"\citet{Hyland2023}",
    "G326.6618+00.5207":   r"\citet{Moises2011}",
    "G014.9958-00.6732":   r"\citet{Wu2019}",
    "G015.0357-00.6795":   r"\citet{Wu2019}",
    "G015.1288-00.6717":   r"\citet{Wu2019}",
    "G133.6923+01.2270":   r"\citet{Xu2006}",
    "G133.6945+01.2166A":  r"\citet{Xu2006}",
    "G133.6945+01.2166B":  r"\citet{Xu2006}",
    "G133.7150+01.2155":   r"\citet{Xu2006}",
    "G133.7184+01.2237":   r"\citet{Xu2006}",
    "G133.7354+01.1827":   r"\citet{Xu2006}",
    "G133.9476+01.0648":   r"\citet{Xu2006}",
    "G192.6005-00.0479":   r"\citet{Burns2016}",
